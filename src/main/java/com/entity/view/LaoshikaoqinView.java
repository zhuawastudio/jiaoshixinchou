...
public class LaoshikaoqinView extends LaoshikaoqinEntity implements Serializable {
	...
	*/
	...
	private String laoshikaoqinValue;
	...
	* 获取： 考勤结果的值
	*/
	public String getLaoshikaoqinValue() {
		return laoshikaoqinValue;
	}
	/**
	* 设置： 考勤结果的值
	*/
	public void setLaoshikaoqinValue(String laoshikaoqinValue) {
		this.laoshikaoqinValue = laoshikaoqinValue;
	}
	...
	public String toString() {
		return "LaoshikaoqinView{" +
			", laoshikaoqinValue=" + laoshikaoqinValue +
