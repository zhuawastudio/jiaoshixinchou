...
public class KeyanView extends KeyanEntity implements Serializable {
	...
	* 科研类型的值
	*/
	@ColumnInfo(comment="科研类型的字典表值",type="varchar(200)")
	private String keyanValue;
	...
	* 获取： 科研类型的值
	*/
	public String getKeyanValue() {
		return keyanValue;
	}
	/**
	* 设置： 科研类型的值
	*/
	public void setKeyanValue(String keyanValue) {
		this.keyanValue = keyanValue;
	}
