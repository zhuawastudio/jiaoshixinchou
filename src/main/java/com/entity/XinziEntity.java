...
public class XinziEntity<T> implements Serializable {
     ...
     * 应到天数
     */
    @ColumnInfo(comment="应到天数",type="int(11)")
     ...
     * 实到天数
     */
    @ColumnInfo(comment="实到天数",type="int(11)")
     ...
     * 扣除金额
     */
    @ColumnInfo(comment="扣除金额",type="decimal(10,2)")
    ...
    public String toString() {
        return "Xinzi{" +
            ...
            ", butieJine=" + butieJine +
            ", yingdaoNumber=" + yingdaoNumber +
            ", shidaoNumber=" + shidaoNumber +
            ", kouchuJine=" + kouchuJine +
            ", shifaJine=" + shifaJine +
