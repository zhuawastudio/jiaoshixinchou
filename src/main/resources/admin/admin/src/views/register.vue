    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">教师薪酬管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="老师编号" class="input" v-if="tableName=='laoshi'">
                                <el-input v-model="ruleForm.laoshiUuidNumber" autocomplete="off" placeholder="老师编号"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // laoshi 中的 账户状态 判空处理
                            // if('laoshi' == this.tableName && (this.ruleForm.jinyongTypes== null ||this.ruleForm.jinyongTypes== "")){
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/jiaoshixinchou/img/back-img-bg.jpg);
