<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='laoshi'"  label='老师编号' prop="laoshiUuidNumber">
               <el-input v-model="ruleForm.laoshiUuidNumber"disabled="true"   placeholder='老师编号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
         ...
         <el-col :span="12">
             <el-form-item v-if="flag!='users' &&( 1==2|| flag=='laoshi')"  label="性别" prop="sexTypes">
...
// 注册表 老师 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.jinyongTypes)&& 'laoshi'==this.flag){
                             this.$message.error('账户状态不能为空');
                             return
                         }

        if((!this.ruleForm.sexTypes) && (1==2|| this.flag=='laoshi')){
