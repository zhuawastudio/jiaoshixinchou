    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="考勤结果" prop="laoshikaoqinTypes">
                        <el-select v-model="ruleForm.laoshikaoqinTypes" :disabled="ro.laoshikaoqinTypes" placeholder="请选择考勤结果">
                            <el-option
                                v-for="(item,index) in laoshikaoqinTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="考勤结果" prop="laoshikaoqinValue">
                        <el-input v-model="ruleForm.laoshikaoqinValue"
                            placeholder="考勤结果" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.laoshikaoqinContent"  label="考勤备注" prop="laoshikaoqinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.laoshikaoqinContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.laoshikaoqinContent" label="考勤备注" prop="laoshikaoqinContent">
                            <span v-html="ruleForm.laoshikaoqinContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    laoshiId: false,
                    laoshikaoqinTypes: false,
                    laoshikaoqinContent: false,
                    kaoqinTime: false,
                    insertTime: false,
                },
                ruleForm: {
                ...
                rules: {
                   ...
                   laoshikaoqinContent: [
                              { required: true, message: '考勤备注不能为空', trigger: 'blur' },
                          ],
                   kaoqinTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=laoshikaoqin_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.laoshikaoqinTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `laoshikaoqin/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.laoshiChange(data.data.laoshiId)
                        _this.ruleForm.laoshikaoqinContent = _this.ruleForm.laoshikaoqinContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.laoshikaoqinContent = this.ruleForm.laoshikaoqinContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`laoshikaoqin/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.laoshikaoqinCrossAddOrUpdateFlag = false;
                                        this.parent.search();
