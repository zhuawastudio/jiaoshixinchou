    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="请假缘由" prop="laoshiqingjiaText">
                        <el-input type="textarea"  :readonly="ro.laoshiqingjiaText" v-model="ruleForm.laoshiqingjiaText" placeholder="请假缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.laoshiqingjiaText" label="请假缘由" prop="laoshiqingjiaText">
                            <span v-html="ruleForm.laoshiqingjiaText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="请假类型" prop="laoshiqingjiaTypes">
                        <el-select v-model="ruleForm.laoshiqingjiaTypes" :disabled="ro.laoshiqingjiaTypes" placeholder="请选择请假类型">
                            <el-option
                                v-for="(item,index) in laoshiqingjiaTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="请假类型" prop="laoshiqingjiaValue">
                        <el-input v-model="ruleForm.laoshiqingjiaValue"
                            placeholder="请假类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.laoshiqingjiaTime"  class="input" label="请假时间" prop="laoshiqingjiaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.laoshiqingjiaTime"
                                type="datetime"
                                placeholder="请假时间"
                                :disabled="ro.laoshiqingjiaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.laoshiqingjiaTime" label="请假时间" prop="laoshiqingjiaTime">
                            <span v-html="ruleForm.laoshiqingjiaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假天数" prop="laoshiqingjiaNumber">
                       <el-input v-model="ruleForm.laoshiqingjiaNumber"
                                 placeholder="请假天数" clearable  :readonly="ro.laoshiqingjiaNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="请假天数" prop="laoshiqingjiaNumber">
                           <el-input v-model="ruleForm.laoshiqingjiaNumber"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.laoshiqingjiaYesnoTypes" label="申请状态" prop="laoshiqingjiaYesnoTypes">
                        <el-input v-model="ruleForm.laoshiqingjiaYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.laoshiqingjiaYesnoText" label="处理意见" prop="laoshiqingjiaYesnoText">
                        <span v-html="ruleForm.laoshiqingjiaYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.laoshiqingjiaShenheTime" label="审核时间" prop="laoshiqingjiaShenheTime">
                        <span v-html="ruleForm.laoshiqingjiaShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    laoshiId: false,
                    laoshiqingjiaText: false,
                    laoshiqingjiaTypes: false,
                    insertTime: false,
                    laoshiqingjiaTime: false,
                    laoshiqingjiaNumber: false,
                    laoshiqingjiaYesnoTypes: false,
                    laoshiqingjiaYesnoText: false,
                    laoshiqingjiaShenheTime: false,
                },
                ruleForm: {
                    laoshiId: '',
                    laoshiqingjiaText: '',
                    ...
                    laoshiqingjiaTime: '',
                    laoshiqingjiaNumber: '',
                    laoshiqingjiaYesnoTypes: '',
                    laoshiqingjiaYesnoText: '',
                    laoshiqingjiaShenheTime: '',
                },
                laoshiqingjiaTypesOptions : [],
                laoshiqingjiaYesnoTypesOptions : [],
                laoshiOptions : [],
                rules: {
                   laoshiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=laoshiqingjia_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.laoshiqingjiaTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=laoshiqingjia_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.laoshiqingjiaYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`laoshiqingjia/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.laoshiqingjiaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
