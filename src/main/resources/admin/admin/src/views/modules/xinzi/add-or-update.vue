    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="应到天数" prop="yingdaoNumber">
                       <el-input v-model="ruleForm.yingdaoNumber"
                                 placeholder="应到天数" clearable  :readonly="ro.yingdaoNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="应到天数" prop="yingdaoNumber">
                           <el-input v-model="ruleForm.yingdaoNumber"
                                     placeholder="应到天数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实到天数" prop="shidaoNumber">
                       <el-input v-model="ruleForm.shidaoNumber"
                                 placeholder="实到天数" clearable  :readonly="ro.shidaoNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实到天数" prop="shidaoNumber">
                           <el-input v-model="ruleForm.shidaoNumber"
                                     placeholder="实到天数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="扣除金额" prop="kouchuJine">
                       <el-input v-model="ruleForm.kouchuJine"
                                 placeholder="扣除金额" clearable  :readonly="ro.kouchuJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="扣除金额" prop="kouchuJine">
                           <el-input v-model="ruleForm.kouchuJine"
                                     placeholder="扣除金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kouchuJine: [
                              { required: true, message: '扣除金额不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
